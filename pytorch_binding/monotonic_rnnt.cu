...
int cpu_monotonic_rnnt_align_restrict(torch::Tensor& acts, torch::Tensor& labels, torch::Tensor& input_lengths,
                                      ...
                                      int max_distance_from_alignment, torch::Tensor& costs, torch::Tensor& grads,
    ...
    workspace_manager.restrict_to_alignment(alignment.data_ptr<int>(), max_distance_from_alignment, blank_label);
